...
Run a manual scan on your git repositories by adding the **ansible-code-bot-scan** topic to your repository. For more information, see [Manually scan your Git repositories](#manually-scan-repo_using-code-bot-for-suggestions "7.3.1.1.&nbsp;Manually scanning the repository from the Ansible code bot dashboard").
