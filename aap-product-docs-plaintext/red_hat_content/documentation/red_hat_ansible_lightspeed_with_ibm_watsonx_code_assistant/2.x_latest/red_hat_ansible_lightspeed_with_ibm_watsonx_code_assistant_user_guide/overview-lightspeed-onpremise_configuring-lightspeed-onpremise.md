...
To see the rest of the Red Hat Ansible Automation Platform system requirements, see the [System requirements](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/planning_your_installation/platform-system-requirements) section of *Planning your installation*.
