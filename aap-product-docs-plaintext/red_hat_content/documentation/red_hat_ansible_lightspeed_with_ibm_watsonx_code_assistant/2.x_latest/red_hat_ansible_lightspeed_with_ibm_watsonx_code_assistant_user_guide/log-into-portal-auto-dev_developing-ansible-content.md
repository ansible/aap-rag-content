...
<span id="idm139735357216896"></span>
**Table 5.1. User login scenarios**

|  **Scenario** |  **Result** |
| --- | --- |
| You are a RH-SSO user. | This is the typical scenario for accessing Red Hat Ansible Lightspeed as an Ansible user. |
| You are routed to the Red Hat Ansible Lightspeed paid commercial offering. | You are a RH-SSO user, but your organization administrator has not configured Red Hat Ansible Lightspeed to connect with IBM watsonx Code Assistant. |
