...
You can also disable the Admin dashboard telemetry if you no longer want to collect and monitor the telemetry data. For more information about Admin dashboard telemetry, see [Viewing and managing Admin dashboard telemetry](#view-manage-admin-dashboard-telemetry_administering-ansible-lightspeed "6.2.&nbsp;Viewing and managing the Admin dashboard telemetry").
