...
After configuring Ansible VS Code extension to connect to Red Hat Ansible Lightspeed on-premise deployment, you must [log in to Ansible Lightspeed through the Ansible VS Code extension](#login-vscode-extension_developing-ansible-content "5.2.4.&nbsp;Logging in to Ansible Lightspeed through the Ansible VS Code extension").
