...
Specify the optional key/value pair as `model_verify_ssl=true` in the model secret to connect to an IBM watsonx Code Assistant model. For details about the procedure, see [Creating connection secrets](#create-connection-secrets_configuring-lightspeed-onpremise "4.3.3.&nbsp;Creating a model configuration secret").
