...
### 6.2.1. Manually scanning your Git repositories
...
#### 6.2.1.1. Manually scanning the repository from the Ansible code bot dashboard
...
#### 6.2.1.2. Manually scanning the repository from GitHub
