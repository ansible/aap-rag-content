...
- Obtain your manifest file. See [Obtaining a manifest file](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/containerized_installation/assembly-gateway-licensing#assembly-aap-obtain-manifest-files) for more information.
...
3. Enter the **client secret** you received when you created your service account in the field labeled Client secret.

Your subscription appears in the **Subscription** list.

3. Select your subscription and click Next.
