...
For more information about Ansible content, see [Create automation content](#con-gs-create-automation-content "3.2.&nbsp;Create automation content with playbooks") in [Getting started as an automation developer](#assembly-gs-auto-dev "Chapter&nbsp;3.&nbsp;Getting started as an automation developer").
