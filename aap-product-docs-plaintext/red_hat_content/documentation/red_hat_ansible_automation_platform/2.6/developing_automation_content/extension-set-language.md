...
## 3.1. Requirements
### 3.1.6. Manually adding the Ansible language to YAML files
...
#### 3.1.6.1. Associating the Ansible language to YAML files
...
#### 3.1.6.2. Adding persistent file association for the Ansible language to `settings.json`
...
1. Click the `        Remote` (![Remote](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/706517b6299d38221f473c0bce4863e1/vscode-remote-icon.png)
) icon.
...
-  [Executing a playbook from automation content navigator](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_content_navigator/assembly-execute-playbooks-navigator_ansible-navigator#proc-execute-playbook-tui_execute-playbooks-navigator)
...
<span id="idm140258413042480"></span>
# Legal Notice
