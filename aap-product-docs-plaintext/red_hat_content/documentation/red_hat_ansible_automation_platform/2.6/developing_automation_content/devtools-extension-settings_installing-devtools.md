...
1. Click the ![Extensions](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/417ed5315a44493c6a44ae5c12dc6fab/vscode-extensions-icon.png) **Extensions** icon in the activity bar.
...
2. Click the **Extensions** ( ![Extensions](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/417ed5315a44493c6a44ae5c12dc6fab/vscode-extensions-icon.png) ) icon in the Activity Bar, or click View → Extensions, to display the **Extensions** view.
...
- If you are installing Ansible development tools on Windows, launch VS Code and connect to the WSL machine. Click the `Remote`( ![Remote](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/706517b6299d38221f473c0bce4863e1/vscode-remote-icon.png) ) icon. In the dropdown menu that appears, select the option to connect to the WSL machine.
...
![Reopen in container](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/396c911927f946c71508d085befd3e04/devtools-reopen-in-container.png)
Click **Reopen in Container**.

- If the notification does not appear, click the `Remote` ( ![Remote](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/706517b6299d38221f473c0bce4863e1/vscode-remote-icon.png) ) icon. In the dropdown menu that appears, select **Reopen in Container**.
...
## 4.1. Associating the Ansible language to YAML files
...
## 4.2. Adding persistent file association for the Ansible language to `settings.json`
...
# Chapter 5. Creating a playbook project
...
## 5.1. Scaffolding a playbook project
...
# Chapter 6. Writing and running a playbook with Ansible development tools

Learn how to write, inspect, debug, and run Ansible playbooks directly within VS Code using Ansible development tools.

## 6.1. Setting up the Ansible configuration file for your playbook project
...
To learn more about the Ansible configuration file, see [Reviewing your Ansible configuration with automation content navigator](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_content_navigator/assembly-review-config-navigator_installing-devtools).

## 6.2. Writing your first playbook
...
![Ansible-lint showing no errors in a playbook](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/6481d621aaf9e19180ca0fa03cff54ea/ansible-lint-no-errors.png)
...
![Ansible-lint showing no errors in a playbook](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/e134cf2cc46c309472833e581fef773f/ansible-lint-keyword-help.png)
...
![Ansible-lint showing no errors in a playbook](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/ce331f515e980027fbd1ecd8000a82cf/ansible-lint-module-completion.png)

## 6.4. Debugging your playbook
...
![Popup message explaining a playbook error](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/afc6eabd5cb29b92ae87af7528c73ca2/ansible-lint-errors.png)
...
![Playbook errors shown in Problems tab and explorer list](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/c7bd61a7d56db99093cb1390f508e5d0/ansible-lint-errors-explorer.png)
`$[0].tasks[0].name None is not of type 'string'` indicates that the playbook does not have a label.

## 6.5. Running your playbook
...
### 6.5.1. Running your playbook with `ansible-playbook`
...
![Run playbook via ansible-playbook](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/73a0c743e4f7c0f2a2f8073956b2fed4/ansible-playbook-run.png)
...
![Success message for ansible-playbook execution](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/f7c82c475842a919188ec2aa473d5b0f/ansible-playbook-success.png)

### 6.5.2. Running your playbook with `ansible-navigator`
...
![Output for ansible-navigator execution](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/bbf860d1eec56d58648bfec6da63551f/devtools-extension-navigator-output.png)
...
![Tasks in ansible-navigator output](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Developing_automation_content-en-US/images/7cf0a79f0236bfcc6bdb9e9bd00c9cf5/devtools-extension-navigator-tasks.png)

Type the number next to a task to review the task results.

**Additional resources**

- [Executing a playbook from automation content navigator](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_content_navigator/assembly-execute-playbooks-navigator_installing-devtools#proc-execute-playbook-tui_execute-playbooks-navigator)

### 6.5.3. Working with execution environments
...
3. Using the information in the [Red Hat Ecosystem Catalog](https://catalog.redhat.com/search?searchType=containers&build_categories_list=Automation%20execution%20environment&p=1), download the execution environment you need.
...
4. After customizing your execution environment, you can push your new image to the container registry in automation hub. See [Publishing an automation execution environment](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/creating_and_using_execution_environments/index#assembly-publishing-exec-env) in the *Creating and using execution environments* documentation.

## 6.6. Testing your playbooks
...
## 7.1. Saving your project in SCM
...
## 7.2. Running your playbook in Ansible Automation Platform
...
2. Configure a Source Control credential type for your source control system if necessary. See the [Creating new credentials](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_automation_execution/controller-credentials#controller-create-credential) section of *Using automation execution* for more details.
3. In automation controller, create a project for the GitHub repository where you stored your playbook project. Refer to the [Projects](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_automation_execution/controller-projects) chapter of *Using automation execution*.
4. Create a job template that uses a playbook from the project that you created. Refer to the [Job Templates](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_automation_execution/controller-job-templates) chapter of *Using automation execution*.
5. Run your playbook from automation controller by launching the job template. Refer to the [Launching a job template](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_automation_execution/controller-job-templates#controller-launch-job-template) section of *Using automation execution*.

# Chapter 8. Developing collections
...
# Chapter 9. Creating a collection for distributing roles
...
- A Red Hat account and log in access to the Red Hat container registry at registry.redhat.io. For information about logging in to registry.redhat.io, see [Authenticating with the Red Hat container registry](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/developing_automation_content/installing-devtools#devtools-setup-registry-redhat-io_installing-devtools).

## 9.3. Scaffolding a collection for your roles
...
## 9.4. Migrating existing roles to your collection
...
## 9.5. Creating a new role in your collection
...
## 9.6. Adding documentation for your roles collection
...
## 9.7. Publishing your collection in private automation hub
...
1. Create a namespace for your collection in private automation hub. See [Creating a namespace](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/managing_automation_content/managing-collections-hub#proc-create-namespace) in the *Managing automation content* guide.
2. Optional: Add information to your namespace. See [Adding additional information and resources to a namespace](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/managing_automation_content/managing-collections-hub#proc-edit-namespace) in the *Managing automation content* guide.
3. Upload your roles collections tarballs to your namespace. See [Uploading collections to your namespaces](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/managing_automation_content/managing-collections-hub#proc-uploading-collections) in the *Managing automation content* guide.
4. Approve your collection for internal publication. See [Uploading collections to your namespaces](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/managing_automation_content/managing-collections-hub#proc-approve-collection) in the *Managing automation content* guide.

### 9.7.1. Using your collection in projects in Red Hat Ansible Automation Platform
