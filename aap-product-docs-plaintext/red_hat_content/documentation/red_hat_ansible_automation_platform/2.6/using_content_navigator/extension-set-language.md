...
1. Click the `        Remote` (![Remote](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_content_navigator-en-US/images/706517b6299d38221f473c0bce4863e1/vscode-remote-icon.png)
) icon.
...
- If the notification does not appear, click the `        Remote` (![Remote](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_content_navigator-en-US/images/706517b6299d38221f473c0bce4863e1/vscode-remote-icon.png)
