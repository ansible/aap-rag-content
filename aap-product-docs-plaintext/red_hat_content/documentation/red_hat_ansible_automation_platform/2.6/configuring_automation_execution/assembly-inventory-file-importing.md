...
To use old inventory scripts in source control, see [Export old inventory scripts](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_automation_execution/controller-inventories#ref-controller-export-old-scripts) in *Using automation execution*.
