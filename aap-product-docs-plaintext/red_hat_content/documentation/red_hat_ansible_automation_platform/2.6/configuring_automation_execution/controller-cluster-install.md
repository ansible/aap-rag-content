...
For more information about `routable_hostname`, see [General variables](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/rpm_installation/appendix-inventory-files-vars#ref-genera-inventory-variables) in the *RPM installation*.
