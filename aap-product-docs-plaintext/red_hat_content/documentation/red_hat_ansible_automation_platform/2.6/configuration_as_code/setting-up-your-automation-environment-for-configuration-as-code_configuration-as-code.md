...
For more information about creating tokens, see [Adding tokens](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/access_management_and_authentication/gw-token-based-authentication#proc-controller-apps-create-tokens) in *Access management and authentication*.
...
- [Adding tokens](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/access_management_and_authentication/gw-token-based-authentication#proc-controller-apps-create-tokens) in *Access management and authentication* for creating OAuth 2 tokens through the platform gateway UI.
- [create_oauth2_token](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/access_management_and_authentication/gw-token-based-authentication#ref-controller-create-oauth2-token) in *Access management and authentication* for creating tokens from the command line.
- [ansible.platform](https://console.redhat.com/ansible/automation-hub/repo/published/ansible/platform/content/?showing=module) collection on Automation hub for module reference documentation.
- The `ansible.platform` collection replaces the service-specific `ansible.controller`, `ansible.hub`, and `ansible.eda` collections. For more information, see [Deprecated features](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/release_notes/aap-2.6-deprecated-features) in the *Release Notes* for Ansible Automation Platform 2.6.
