...
- The left part of a search parameter can be wrapped in quotes to support searching for strings with spaces. For more information, see [Rules for searching](#ref-controller-search-tips "4.1.&nbsp;Rules for searching").
