...
4. To customize your domain options, select the ![Wrench](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_automation_execution-en-US/images/7a43f0108a64710b5a161addfa9a8b3b/wrench.png) icon. In the modal that appears, select **Add Domain** to add new domains to filter with.
