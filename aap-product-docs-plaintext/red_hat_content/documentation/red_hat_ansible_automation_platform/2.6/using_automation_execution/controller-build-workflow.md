...
- If you select an **Approval** node, see [Approval nodes](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/using_automation_execution/index#controller-approval-nodes) for more information.
