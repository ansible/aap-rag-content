...
3. Click the copy ![Copy](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_automation_execution-en-US/images/df17e3afcfb728d4887b97e8605bd65c/copy.png) icon to copy the API token to the clipboard.
...
8. In the **Projects** list view, click the sync ![Update](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_automation_execution-en-US/images/8ca24410ba90c880998d13dfe67a52b0/sync.png) icon to update this project. Automation controller fetches the Galaxy collections from the `collections/requirements.yml` file and reports it as changed. The collections are installed for any job template using this project.
