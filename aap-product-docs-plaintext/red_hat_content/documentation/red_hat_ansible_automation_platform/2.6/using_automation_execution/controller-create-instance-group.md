...
Note
The default value of 0 for **Max concurrent jobs** and **Max forks** denotes no limit. For more information, see [Instance group capacity limits](#controller-instance-group-capacity "18.1.8.&nbsp;Instance group capacity limits").
