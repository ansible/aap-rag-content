...
If you have already added your subscription, you can update your subscription details in the subscription wizard by going to Settings → Subscription → Edit subscription.
...
2. In the **Client ID** field, enter the client ID you received when you created your service account.
3. In the **Client secret** field, enter the client secret you received when you created your service account. Your subscription is displayed in the list menu labeled **Subscription**. Select your subscription.

2. After you have added your subscription, click Next.

3. Check the box indicating that you agree to the **End User License Agreement**.

4. Review your information and click **Finish**.
