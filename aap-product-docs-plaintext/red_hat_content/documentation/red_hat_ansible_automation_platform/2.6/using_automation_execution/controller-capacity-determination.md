...
Instance groups, not instances themselves, can be assigned to be used by jobs at various levels. For more information, see [Clustering](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/configuring_automation_execution/controller-clustering) in *Configuring automation execution*.
...
- [Job slice execution behavior](#controller-job-slice-execution-behavior "7.2.&nbsp;Job slice execution behavior")
