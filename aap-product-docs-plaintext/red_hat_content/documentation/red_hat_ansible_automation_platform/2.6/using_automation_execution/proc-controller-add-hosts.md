...
10. You can disassociate a host from this screen by selecting the host and clicking the ![Disassociate](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_automation_execution-en-US/images/48c2fa70cf2a09ae0fafa81899b143fc/disassociate.png) icon.


Note
You can also run ad hoc commands from this screen. For more information, see [Running Ad Hoc commands](#proc-controller-run-ad-hoc-commands "14.6.&nbsp;Running Ad Hoc commands").
