...
You can export the cost and savings analysis as a CSV or PDF file. You must specify a date range to generate a PDF report. For more information, see [Exporting automation reports](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/using_automation_dashboard/index#proc-exporting-reports_verifying-tokens).
