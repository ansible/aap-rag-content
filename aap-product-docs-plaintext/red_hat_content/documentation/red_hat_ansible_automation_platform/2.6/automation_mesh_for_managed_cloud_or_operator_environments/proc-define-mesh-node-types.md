...
![Create new Instance](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Automation_mesh_for_managed_cloud_or_operator_environments-en-US/images/3355dec0d74db565c318375fabb769dc/instances_create_new.png)
...
4. To verify peering configuration and the direction of traffic, you can use the topology view to view a graphical representation of your updated topology. This can help to determine where your firewall rules might need to be updated. For more information, see [Topology view](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/using_automation_execution/assembly-controller-topology-viewer).


Note
Complete the following steps from any computer that has SSH access to the newly created instance.

5. Click the ![Download](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Automation_mesh_for_managed_cloud_or_operator_environments-en-US/images/8a61e20c21c53f44e207c84d454159ec/download.png) icon next to **Download Bundle** to download the tar file that includes this new instance and the files necessary to install the created node into the automation mesh.
