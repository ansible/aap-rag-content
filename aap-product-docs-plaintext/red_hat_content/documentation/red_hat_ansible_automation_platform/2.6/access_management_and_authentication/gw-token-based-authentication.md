...
For more information about using the `manage` utility to create tokens, see [Token and session management](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/access_management_and_authentication/index#ref-controller-token-session-management) .
