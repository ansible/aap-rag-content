...
1. ClickCreate Authentication Methodand proceed to [Define authentication mapping rules and triggers](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/access_management_and_authentication/index#gw-define-rules-triggers) .
