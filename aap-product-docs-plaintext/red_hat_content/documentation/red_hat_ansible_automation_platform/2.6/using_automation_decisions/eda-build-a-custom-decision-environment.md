...
- If you want to connect Event-Driven Ansible controller to Ansible Automation Platform 2.6, you must use `        registry.redhat.io/ansible-automation-platform-25/de-minimal-rhel9:latest`
