...
### 11.1.1. Modifying the default memory limit for each rulebook activation
...
#### 11.1.1.1. Modifying the default memory limit for each rulebook activation during installation
...
#### 11.1.1.2. Modifying the default memory limit for each rulebook activation after installation
