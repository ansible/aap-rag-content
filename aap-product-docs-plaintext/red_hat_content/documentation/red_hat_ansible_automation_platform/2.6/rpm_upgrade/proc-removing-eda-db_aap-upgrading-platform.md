...
1. [Run the Ansible Automation Platform installer setup script](#proc-running-setup-script-for-updates "2.5.&nbsp;Running the Red Hat Ansible Automation Platform installer setup script").
