...
<span id="idm139764052177120"></span>
...
-  [Using custom TLS certificates](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/containerized_installation/aap-containerized-installation#using-custom-tls-certificates)
...
1. Add the absolute paths of the SSL certificates and keys to the inventory file. Refer to the [Automation controller variables](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/rpm_installation/appendix-inventory-files-vars#controller-variables) , [Automation hub variables](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/rpm_installation/appendix-inventory-files-vars#hub-variables) , and [Event-Driven Ansible controller variables](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/rpm_installation/appendix-inventory-files-vars#event-driven-ansible-variables) sections of [RPM installation](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/rpm_installation) for guidance on setting these variables.
...
<span id="idm139764057032304"></span>
# Legal Notice
