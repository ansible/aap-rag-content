...
2. Verify that new SSL/TLS certificate and key have been installed:
...
2. Add the absolute paths of the SSL/TLS certificates and keys to the inventory file. Refer to [Inventory file variables](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/rpm_installation/appendix-inventory-files-vars) for guidance on setting these variables.
