...
To activate Ansible Automation Platform using credentials, see [Activate with credentials](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/access_management_and_authentication/assembly-gateway-licensing#proc-aap-activate-with-credentials) .

To activate Ansible Automation Platform with a manifest file, see [Activate with a manifest file](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html/access_management_and_authentication/assembly-gateway-licensing#proc-aap-activate-with-manifest) .
