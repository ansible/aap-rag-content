...
| <br> **Validated Collection** | <br> **Collection Purpose** |
| --- | --- |
...
| <br> `infra.ee_utilities` | <br>  A collection of roles for creating and managing execution environment images, or migrating from the older Ansible Tower virtualenvs to execution environments. |
