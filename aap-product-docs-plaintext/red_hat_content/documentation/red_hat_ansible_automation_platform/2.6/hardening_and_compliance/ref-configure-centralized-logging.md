...
1. On Ansible Automation Platform 2.6 RPM-based, the file is `        /etc/ansible-automation-platform/gateway/settings.py` .
...
1. On Ansible Automation Platform 2.6 RPM-based, use the `        automation-gateway-service` command:
