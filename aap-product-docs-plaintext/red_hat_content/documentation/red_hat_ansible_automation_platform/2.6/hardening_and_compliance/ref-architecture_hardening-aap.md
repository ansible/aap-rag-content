...
- Restrict SSH access to the Ansible Automation Platform servers from the [installation host](#con-install-secure-host_hardening-aap "2.2.1.&nbsp;Install from a dedicated installation host") and other trusted systems used for maintenance access to the Ansible Automation Platform servers.
