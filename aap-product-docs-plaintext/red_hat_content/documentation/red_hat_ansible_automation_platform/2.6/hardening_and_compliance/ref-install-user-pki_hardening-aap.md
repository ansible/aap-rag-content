...
By default, Ansible Automation Platform creates self-signed _Public Key Infrastructure_ (PKI) certificates for the infrastructure components of the platform.
...
<span id="idm140601135556800"></span>
