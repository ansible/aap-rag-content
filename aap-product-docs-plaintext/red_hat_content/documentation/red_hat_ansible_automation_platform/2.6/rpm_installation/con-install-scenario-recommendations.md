...
1.  [Apply the appropriate SELinux context](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/rpm_installation/index#proc-apply-selinux-context) .
