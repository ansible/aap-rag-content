...
| Installer | Location |
| --- | --- |
| <br> **RPM** | <br> `/opt/ansible-automation-platform/installer` |
| <br> **RPM bundle tar** | <br> `/ansible-automation-platform-setup-bundle-<latest-version>` |
| <br> **RPM non-bundle tar** | <br> `/ansible-automation-platform-setup-<latest-version>` |
| <br> **Container bundle tar** | <br> `/ansible-automation-platform-containerized-setup-bundle-<latest-version>` |
| <br> **Container non-bundle tar** | <br> `/ansible-automation-platform-containerized-setup-<latest-version>` |
