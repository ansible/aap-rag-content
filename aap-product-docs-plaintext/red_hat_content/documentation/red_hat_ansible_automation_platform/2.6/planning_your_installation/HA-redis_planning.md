...
In Ansible Automation Platform 2.6, [Redis (REmote DIctionary Server)](https://redis.io/) is used as the caching and queueing system. Redis is an open source, in-memory, NoSQL key/value store that is used primarily as an application cache, quick-response database and lightweight message broker.
...
<span id="idm140410397873728"></span>
