...
Note
If you have a problem with a change to your custom repository, you can [revert to a different repository version](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/managing_automation_content/index#proc-revert-repository-version) that you have retained.
