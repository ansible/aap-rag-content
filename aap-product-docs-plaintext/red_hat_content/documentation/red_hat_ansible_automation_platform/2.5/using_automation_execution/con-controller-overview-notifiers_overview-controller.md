...
-  [Webhook](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/using_automation_execution/index#controller-notification-webhook) (post to an arbitrary webhook, for integration into other tools)
