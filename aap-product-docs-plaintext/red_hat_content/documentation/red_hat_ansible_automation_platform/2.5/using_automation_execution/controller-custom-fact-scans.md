...
A playbook for a custom fact scan is similar to the example in the [Fact scan playbooks](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/using_automation_execution/index#controller-fact-scan-playbooks) section. For example, a playbook that only uses a custom `scan_foo` Ansible fact module looks similar to this:
