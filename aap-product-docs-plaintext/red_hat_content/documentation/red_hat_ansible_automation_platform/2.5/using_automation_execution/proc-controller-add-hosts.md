...
1. You can disassociate a host from this screen by selecting the host and clicking the![Disassociate](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/48c2fa70cf2a09ae0fafa81899b143fc/disassociate.png)
icon.

Note
You can also run ad hoc commands from this screen. For more information, see [Running Ad Hoc commands](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/using_automation_execution/index#proc-controller-run-ad-hoc-commands) .
