...
- For information about container groups, see [Capacity settings for instance group and container group](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/configuring_automation_execution/assembly-controller-improving-performance#ref-controller-settings-control-execution-nodes) in _Configuring automation execution_ .
- For information about sliced jobs and their impact to capacity, see [Job slice execution behavior](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/using_automation_execution/index#controller-job-slice-execution-behavior) .
