...
-  [Unable to connect to Ansible Automation Platform](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/installing_ansible_plug-ins_for_red_hat_developer_hub/index#rhdh-warning-unable-connect-aap_rhdh-subscription-warnings)
-  [Unable to authenticate to Ansible Automation Platform](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/installing_ansible_plug-ins_for_red_hat_developer_hub/index#rhdh-warning-unable-authenticate-aap_rhdh-subscription-warnings)
-  [Invalid Ansible Automation Platform configuration](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/installing_ansible_plug-ins_for_red_hat_developer_hub/index#rhdh-warning-invalid-aap-config_rhdh-subscription-warnings)
-  [Ansible Automation Platform subscription is out of compliance](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/installing_ansible_plug-ins_for_red_hat_developer_hub/index#rhdh-warning-aap-ooc_rhdh-subscription-warnings)
-  [Invalid Ansible Automation Platform subscription](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/installing_ansible_plug-ins_for_red_hat_developer_hub/index#rhdh-warning-invalid-aap-subscription_rhdh-subscription-warnings)
