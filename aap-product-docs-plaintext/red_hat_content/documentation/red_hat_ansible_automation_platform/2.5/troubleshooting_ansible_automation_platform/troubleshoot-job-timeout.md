...
- For more information about the `    DEFAULT_TIMEOUT` configuration setting, see [DEFAULT_TIMEOUT](https://docs.ansible.com/ansible/latest/reference_appendices/config.html#default-timeout) in the Ansible Community Documentation.
