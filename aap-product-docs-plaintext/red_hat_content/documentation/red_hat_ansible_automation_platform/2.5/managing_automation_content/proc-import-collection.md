...
- See [Approval pipeline](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/managing_automation_content/index#con-approval-pipeline) for more information about collection and repository approvals.
