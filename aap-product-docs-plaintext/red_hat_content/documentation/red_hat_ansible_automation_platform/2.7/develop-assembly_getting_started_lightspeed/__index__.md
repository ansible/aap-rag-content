...
-  [Log in to the Ansible Lightspeed admin portal](/documentation/en-us/red_hat_ansible_automation_platform/2.7/develop-assembly_administering_ansible_lightspeed#log-in-administrator-portal "Use the Ansible Lightspeed administrator portal to connect Red Hat Ansible Lightspeed to IBM watsonx Code Assistant.")     Use the Ansible Lightspeed admin portal to access and manage the Ansible Lightspeed service.
