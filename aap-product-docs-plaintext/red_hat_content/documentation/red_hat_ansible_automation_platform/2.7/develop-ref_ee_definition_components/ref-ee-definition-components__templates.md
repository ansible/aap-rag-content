...
| **Networking Automation** | A template optimized for network device interaction with pre-selected networking collections.        | Use this template when your automation primarily interacts with switches, routers, firewalls, and other network infrastructure.                           |
| **Cloud Automation**      | A template optimized for deploying and managing cloud resources with pre-selected cloud collections. | Use this template when your automation targets provisioning, configuration, and management of cloud services.                                             |
