...
Refer to [Backup and diaster recovery](https://docs.redhat.com/en/documentation/ansible_on_clouds/2.x/html-single/red_hat_ansible_automation_platform_service_on_aws/index#con-saas-backup-and-diaster-recovery) for the list of supported and back up regions.
