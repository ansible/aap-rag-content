...
2. Store the information that you entered in the form in a secure place. You must provide the *Administrator password* to access your Ansible Automation Platform.

3. Click Next

4. Follow the steps in [Red Hat Ansible Automation Platform on Microsoft Azure Networking Preparation](https://access.redhat.com/articles/6973251) to configure your network configuration.
...
15. Click Create to begin the provisioning process for the application.
