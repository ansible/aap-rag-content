...
- In the **Redirect URI (optional)** field, enter the *Microsoft Entra ID OAuth2 Callback URL* value that you fetched from Ansible Automation Platform.
...
1. In the **Ansible Automation Platform application registration page** on Azure, copy and save the value of *Application (client) ID*.

You need this value for the *Microsoft Entra ID OAuth2 Key* in the Ansible Automation Platform settings.
...
2. Click the [Cloud Shell](https://learn.microsoft.com/en-us/azure/cloud-shell/overview) icon to open a bash Cloud Shell in your browser.
...
5. Store the service principal details securely, as they are displayed only when you create the secret.
