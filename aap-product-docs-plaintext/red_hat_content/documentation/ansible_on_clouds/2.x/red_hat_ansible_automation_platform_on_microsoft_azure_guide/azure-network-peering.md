...
Refer to [Choose between virtual network peering and VPN gateways](https://learn.microsoft.com/en-us/azure/architecture/reference-architectures/hybrid-networking/vnet-peering) in the Microsoft *Application architecture fundamentals guide* to determine the correct peering approach for your organization.
