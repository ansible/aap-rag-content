...
[extra]
breadcrumbs = [["/", "Home"], ["/products", "Product Documentation"], ["/documentation/en-us/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant/2.x_latest", "Red Hat Ansible Lightspeed with IBM watsonx Code Assistant"], ["/documentation/en-us/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant/2.x_latest", "2.x_latest"]]
category = "User Guide"
category_description = ""
document_kind = "documentation"
html = "data/docs_assets_pv1/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant/2.x_latest/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant_user_guide/single-page/8fe1b823ddc04da0a3882656e70119f6.html"
last_crumb = "Red Hat Ansible Lightspeed with IBM watsonx Code Assistant User Guide"
...
product_slug = "red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant"
...
solr_index = "true"
toc = "data/docs_assets_pv1/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant/2.x_latest/red_hat_ansible_lightspeed_with_ibm_watsonx_code_assistant_user_guide/toc/cdf7acdf388d4dbf2a60de0fc3357e18.json"
type = "single-page"
+++
...
- [Setting up the cloud service](#configure-lightspeed-cloud-service_set-up-lightspeed "4.2.&nbsp;Setting up Red Hat Ansible Lightspeed cloud service")
- [Setting up an on-premise or hybrid deployment](#configuring-lightspeed-onpremise_set-up-lightspeed "4.3.&nbsp;Setting up Red Hat Ansible Lightspeed on-premise deployment")
...
- [Log in to the Ansible Lightspeed admin portal](#log-in-administrator-portal_administering-ansible-lightspeed "6.1.&nbsp;Logging in to the Ansible Lightspeed administrator portal")

    Use the Ansible Lightspeed admin portal to access and manage the Ansible Lightspeed service.

- [View and manage the Admin dashboard telemetry data](#view-manage-admin-dashboard-telemetry_administering-ansible-lightspeed "6.2.&nbsp;Viewing and managing the Admin dashboard telemetry")
...
To access Red Hat Ansible Lightspeed, all Ansible users must install and configure the Ansible VS Code extension in their VS Code editor. For the procedure, see [Install and configure the Ansible VS Code extension](#con-configure-vs-code-extension_developing-ansible-content "5.2.&nbsp;Installing and configuring the Ansible VS Code extension").
...
- [Start a free 90-day trial of Red Hat Ansible Lightspeed](#start-lightspeed-trial_start-lightspeed-trial "3.1.&nbsp;Starting a trial of Red Hat Ansible Lightspeed")
...
- [Create single-task or multitask code recommendations](#con-task-recommendations_developing-ansible-content "5.3.&nbsp;Creating task recommendations")

    You can generate single-task or multitask code recommendations for your task intent using the Ansible VS Code extension.

- [Create Ansible playbooks and view playbook explanations](#playbook-generation_developing-ansible-content "5.4.&nbsp;Creating playbooks and viewing playbook explanations")
...
- [Create roles within a collection and view role explanations](#role-creation_developing-ansible-content "5.5.&nbsp;Creating roles and viewing role explanations")
...
Red Hat Ansible Lightspeed does not collect users' personal information, such as usernames or passwords. If any personal information is inadvertently received, the data is deleted. For more information about Red Hat Ansible Lightspeed’s privacy practices, see the [Telemetry Data Collection Notice for the Admin dashboard](#telemetry-data-collection-notice_lightspeed-intro "1.4.4.&nbsp;Telemetry data collection notice for the Admin dashboard").
