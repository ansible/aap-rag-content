...
<span id="idm140623181888144"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140623181969040) 
 **Abstract** 
...
Each supported region is paired with a companion AWS region where backup data is stored in the event of a primary region catastrophe that requires restoration in another AWS region. Refer to [Backup and diaster recovery](#con-saas-backup-and-diaster-recovery) for the list of supported and back up regions.
...
If you need help accessing your deployment, submit a support request through the [Red Hat Customer Portal](https://access.redhat.com/support) .
