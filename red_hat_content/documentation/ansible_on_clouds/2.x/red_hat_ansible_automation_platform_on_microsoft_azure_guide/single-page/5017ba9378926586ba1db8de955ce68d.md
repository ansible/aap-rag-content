...
html = "data/docs_assets_pv1/ansible_on_clouds/2.x/red_hat_ansible_automation_platform_on_microsoft_azure_guide/single-page/5017ba9378926586ba1db8de955ce68d.html"
last_crumb = "Red Hat Ansible Automation Platform on Microsoft Azure Guide"
modified = "2026-06-18T12:16:34.000Z"
...
solr_index = "true"
toc = "data/docs_assets_pv1/ansible_on_clouds/2.x/red_hat_ansible_automation_platform_on_microsoft_azure_guide/toc/695c0862706f1b24028f11d00fd525fb.json"
type = "single-page"
+++
...
[Legal Notice](#idm139895857188832)
...
Understand the version lifecycle, planned upgrade windows, uptime policy, and support coverage for Red Hat Ansible Automation Platform on Microsoft Azure.

### 1.9.1. Version lifecycle

Red Hat Ansible Automation Platform on Microsoft Azure employs a continuous release approach to versioning, meaning that customers are upgraded to the latest version that Red Hat supports on a cadence that Red Hat defines. Ansible Automation Platform on Microsoft Azure cannot be version locked for customers at this time.
...
| <br>  Ansible Automation Platform on Azure                                 | <br>  Ansible Automation Platform                                                                                                 | <br>  Seeded Content                                                       |
| -------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| <br>  Continuously Released outside of Ansible Automation Platform version | <br>  Updated to maintain cadence with the most recently published version of Ansible Automation Platform (x.y.z release streams) | <br>  Continuously Released outside of Ansible Automation Platform version |
...
As a managed application, Red Hat strives to limit any solution downtime. Red Hat has a team of *Site Reliability Engineers* (SREs) dedicated to Ansible Automation Platform on Microsoft Azure to provide monitoring and cloud offering support. However, there is no current uptime guarantee for Ansible Automation Platform on Azure. Due to the nature of managed applications, such as resources running on a third-party provider (Microsoft Azure), there might be circumstances that cause downtime that are outside of Red Hat control. Red Hat works closely with Microsoft to deliver a stable and reliable solution.

#### 1.9.3.1. Scope of coverage

Support is provided for use according to the published Scope of Coverage in Appendix 1 of the [Red Hat Enterprise Agreement](https://www.redhat.com/en/about/enterprise-agreements). As a managed application, Red Hat supports the managed application as currently deployed to customers. Versions that are not actively in use by Ansible Automation Platform on Azure are not supported.
