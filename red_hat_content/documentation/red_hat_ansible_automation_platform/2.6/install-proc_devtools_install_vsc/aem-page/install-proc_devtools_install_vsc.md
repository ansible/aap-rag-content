...
title = "Install and configure VS Code - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_vsc"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_vsc/aem-page/install-proc_devtools_install_vsc.html"
last_crumb = "Install and configure VS Code"
modified = "2026-05-21T14:12:12.122Z"
multi_page_path = ""
name = "Install and configure VS Code"
oversized = "false"
page_slug = "install-proc_devtools_install_vsc"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_vsc"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_vsc/toc/toc.json"
type = "aem-page"
+++
...
If the extension does not identify the language for your playbook files as Ansible, follow the procedure in [Associating the Ansible language to YAML files](/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-assembly_devtools_install "You have two options for installing Ansible development tools, so that you can choose the installation method that best suits your preferred operating system and development environment.").
...
1.  Open the Ansible extension settings:
  1.  Click the ![Extensions](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/vscode-extensions-icon.png)**Extensions** icon in the activity bar.
