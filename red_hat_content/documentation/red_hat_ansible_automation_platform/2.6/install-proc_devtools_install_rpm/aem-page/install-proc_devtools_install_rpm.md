+++
title = "Install Ansible development tools from an RPM package - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_rpm"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_rpm/aem-page/install-proc_devtools_install_rpm.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_rpm"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_devtools_install_rpm/toc/toc.json"
type = "aem-page"
+++
