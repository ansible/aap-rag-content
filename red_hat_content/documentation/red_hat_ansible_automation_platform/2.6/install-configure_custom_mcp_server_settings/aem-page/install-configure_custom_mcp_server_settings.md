+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-configure_custom_mcp_server_settings"
title = "Configure custom MCP server settings - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-configure_custom_mcp_server_settings/aem-page/install-configure_custom_mcp_server_settings.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-configure_custom_mcp_server_settings"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-configure_custom_mcp_server_settings/toc/toc.json"
type = "aem-page"
+++
