+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-assembly_browse_collections_navigator"
template = "docs/aem-title.html"
title = "Browse collections in a text-based format - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-assembly_browse_collections_navigator/aem-page/develop-assembly_browse_collections_navigator.html"
last_crumb = "Browse collections in a text-based format"
modified = "2026-05-21T14:12:12.122Z"
multi_page_path = ""
name = "Browse collections in a text-based format"
oversized = "false"
page_slug = "develop-assembly_browse_collections_navigator"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/develop-assembly_browse_collections_navigator"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-assembly_browse_collections_navigator/toc/toc.json"
type = "aem-page"
+++
...
![Automation content navigator collections display](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/navigator-collections-shadow.png)  
...
![A list of Ansible collections shown in the automation content navigator](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/navigator-collection-list.png)  
...
![A collection shown in the automation content navigator](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/navigator-plugin-list.png)  
...
![Documentation example shown in the editing tool](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/navigator-vscode-example.png)  

### Results

- Browse the collection list.  
![Collection list](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/navigator-collection-list.png)  
...
![Documentation example in editor](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/navigator-vscode-example.png)  
    See [Automation content navigator general settings](/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-assembly_settings_navigator#ref-navigator-general-settings "The following table describes each general parameter and setting options for automation content navigator.") for details on how to set up your editor.
