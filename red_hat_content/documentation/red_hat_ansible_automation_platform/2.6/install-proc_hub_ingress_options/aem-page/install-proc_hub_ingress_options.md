+++
title = "Configure ingress options for automation hub - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_hub_ingress_options"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_hub_ingress_options/aem-page/install-proc_hub_ingress_options.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-proc_hub_ingress_options"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_hub_ingress_options/toc/toc.json"
type = "aem-page"
+++
