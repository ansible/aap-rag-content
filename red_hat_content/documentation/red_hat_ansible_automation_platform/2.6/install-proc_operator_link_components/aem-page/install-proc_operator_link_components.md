...
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_operator_link_components"
title = "Deploy a new Ansible Automation Platform instance with components - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_operator_link_components/aem-page/install-proc_operator_link_components.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-proc_operator_link_components"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_operator_link_components/toc/toc.json"
type = "aem-page"
+++
