+++
title = "Manage firewall policies and rules with security automation - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/secure-assembly_firewall_policy_manage"
template = "docs/aem-title.html"

[extra]
breadcrumbs = [["/", "Home"], ["/products", "Product Documentation"], ["/documentation/en-us/red_hat_ansible_automation_platform/2.7", "Red Hat Ansible Automation Platform"], ["/documentation/en-us/red_hat_ansible_automation_platform/2.6", "2.6"], ["/documentation/en-us/red_hat_ansible_automation_platform/2.6/secure-assembly_firewall_policy_manage/", "Manage firewall policies and rules with security automation"]]
category = "Secure"
category_description = ""
document_kind = "documentation"
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-assembly_firewall_policy_manage/aem-page/secure-assembly_firewall_policy_manage.html"
...
oversized = "false"
page_slug = "secure-assembly_firewall_policy_manage"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/secure-assembly_firewall_policy_manage"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-assembly_firewall_policy_manage/toc/toc.json"
type = "aem-page"
+++
...
![Simplified security lab environment](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/security-lab-environment.png)  
...
1.  Install the acl_manager role using the ansible-galaxy command.  `$ ansible-galaxy install ansible_security.acl_manager`
...
![Playbook with new firewall rule](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/security-create-rule.png)  
...
![Playbook with deleted firewall rule](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/security-delete-rule.png)  
