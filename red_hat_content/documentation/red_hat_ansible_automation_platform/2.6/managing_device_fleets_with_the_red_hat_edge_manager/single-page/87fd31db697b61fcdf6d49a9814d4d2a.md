...
<span id="idm140484556387024"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140484555058480) 
 **Abstract** 
...
-  [Red Hat Edge Manager architecture](#assembly-edge-manager-architecture) 
-  [Installing the Red Hat Edge Manager](#assembly-edge-manager-install) 
-  [Operating system images for using with the Red Hat Edge Manager](#assembly-edge-manager-images) 
-  [Provision devices](#edge-manager-provisioning-devices) 
-  [Manage devices](#assembly-edge-manager-manage-devices) 
-  [Device fleets](#assembly-edge-manager-device-fleets) 
...
-  [Red Hat Edge Manager agent and service](#edge-manager-agent-service) 
-  [Red Hat Edge Manager API server](#edge-manager-api-server) 
...
-  [Building a bootc operating system image for the Red Hat Edge Manager](#edge-manager-build-bootc) 
-  [Special considerations for building images](#edge-manager-images-special-considerations) 
...
-  [Build-time configuration over dynamic runtime configuration](#edge-manager-buildtime-runtime) 
-  [Configuration in the /usr directory](#edge-manager-usr-dir) 
-  [Drop-in directories](#edge-manager-drop-dir) 
-  [Operating system images with scripts](#edge-manager-os-img-script) 
...
1. Log in to the flightctl CLI by following the steps in [Logging into the Red Hat Edge Manager through the CLI](#edge-manager-log-into-CLI) .
...
For more information, see the [Additional resources](#edge-manager-additional-resources-images) section.
...
1. Create a `    Containerfile` file with the following content to build a RHEL 9-based operating system image that includes the Red Hat Edge Manager agent and configuration:
    ...
    For more information, see [Optional: Requesting an enrollment certificate for early binding](#edge-manager-request-cert) .
...
- You created a private key by using Sigstore. See [Signing and publishing the bootc operating system image by using Sigstore](#edge-manager-build-sign-image) .
...
-  [Building images for Red Hat OpenShift Virtualization](#edge-manager-virt) 
-  [Building images for VMware vSphere](#edge-manager-vmware) 
...
-  [Provision physical devices](#edge-manager-provisioning-physical) 
-  [Provision devices with OpenShift Virtualization](#edge-manager-provisioning-openshift-virt) 
...
-  [Enroll devices](#edge-manager-enroll) 
-  [View devices](#edge-manager-view-devices) 
-  [Labels and label selectors](#edge-manager-labels) 
-  [Updating labels on the CLI](#edge-manager-update-labels) 
-  [Update the operating system](#edge-manager-update-os) 
-  [Operating system configuration for edge devices](#edge-manager-manage-os-config) 
...
-  [Device enrollment](#edge-manager-device-enroll) 
-  [Optional: Requesting an enrollment certificate for early binding](#edge-manager-request-cert) 
...
- You must install the Red Hat Edge Manager CLI. See [Installing the Red Hat Edge Manager CLI](#edge-manager-install-CLI) .
...
For more information, see [Labels and label selectors](#edge-manager-labels) .
...
For more information, see [View devices](#edge-manager-view-devices) .
...
-  [Configuration from a Git repository](#edge-manager-config-git-repo) 
-  [Secrets from a Kubernetes cluster](#edge-manager-k8s-cluster) 
-  [Configuration from an HTTP server](#edge-manager-config-http) 
-  [Configuration inline in the device specification](#edge-manager-config-inline) 
...
-  [Use device lifecycle hooks](#edge-manager-device-lifecycle) 
...
For more information, see [Building a bootc operating system image for use with the Red Hat Edge Manager](#edge-manager-build-bootc) .
