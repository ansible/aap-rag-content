+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/upgrade-assembly_self_service_upgrading"
template = "docs/aem-title.html"
title = "Upgrade Ansible automation portal - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/upgrade-assembly_self_service_upgrading/aem-page/upgrade-assembly_self_service_upgrading.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/upgrade-assembly_self_service_upgrading"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/upgrade-assembly_self_service_upgrading/toc/toc.json"
type = "aem-page"
+++
...
For detailed instructions on this process, see [Installing the Ansible automation portal in an air-gapped environment](/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-assembly_self_service_disconnected_install#self-service-disconnected-install "You can install Ansible automation portal in a disconnected OpenShift Container Platform environment. For new installations, use OCI container delivery and mirror required container images and plug-in artifacts to your internal registry.").
