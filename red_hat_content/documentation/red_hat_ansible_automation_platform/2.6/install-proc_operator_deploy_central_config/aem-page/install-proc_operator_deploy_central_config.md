+++
title = "Add components to an existing deployment - Red Hat Ansible Automation Platform 2.6"
template = "docs/aem-title.html"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_operator_deploy_central_config"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_operator_deploy_central_config/aem-page/install-proc_operator_deploy_central_config.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-proc_operator_deploy_central_config"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_operator_deploy_central_config/toc/toc.json"
type = "aem-page"
+++
