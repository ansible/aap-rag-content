+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_mapping"
title = "Map external authenticators to Ansible Automation Platform - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_mapping/aem-page/secure-assembly_gw_mapping.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_mapping"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_mapping/toc/toc.json"
type = "aem-page"
+++
...
![Add users to an organization mapping example fully annotated with callout numbers that correlate with the following list that describes the function of each field](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/am-org-mapping-full-annotation.png)  
...
![Add user to a team mapping example](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/am-apple-team-map-example.png)  
...
![Do not escalate privileges mapping example](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/am-do-not-escalate-privileges.png)  
...
![Escalate privileges mapping example](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/am-escalate-privileges.png)  
...
![Mapping order example](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/am-mapping-order.png)  
...
4.  Select a **Trigger** from the list. See [Authenticator map triggers](/documentation/en-us/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_mapping#gw-authenticator-map-triggers "Each map has a trigger that defines when the map should be evaluated as true. Trigger types include the following:") for more information about map triggers.
