+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-proc_implementing_automation_content_for_ephemeral_mcp_agents"
title = "Implement automation content for ephemeral MCP agents - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-proc_implementing_automation_content_for_ephemeral_mcp_agents/aem-page/develop-proc_implementing_automation_content_for_ephemeral_mcp_agents.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/develop-proc_implementing_automation_content_for_ephemeral_mcp_agents"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-proc_implementing_automation_content_for_ephemeral_mcp_agents/toc/toc.json"
type = "aem-page"
+++
...
![Creating a custom credential type in Ansible Automation Platform](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/mcp-agents-create-credential-type.png)  

  2.  Create a new credential and use the custom credential type you created.
  
![Creating a credential with the custom credential type](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/mcp-agents-create-credential.png)  
...
![Creating a host with MCP connection variables](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/mcp-agents-create-host.png)  
