+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/configure-proc_settings_user_preferences"
template = "docs/aem-title.html"
title = "User preferences - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/configure-proc_settings_user_preferences/aem-page/configure-proc_settings_user_preferences.html"
last_crumb = "User preferences"
modified = "2026-05-21T14:12:12.122Z"
multi_page_path = ""
name = "User preferences"
oversized = "false"
page_slug = "configure-proc_settings_user_preferences"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/configure-proc_settings_user_preferences"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/configure-proc_settings_user_preferences/toc/toc.json"
type = "aem-page"
+++
...
1.  From the navigation panel, select Settings> (and then)User Preferences.
2.  The **User Preferences page** is displayed.
3.  Click Edit.
4.  You can configure the following options:

  - **Refresh interval**: Select the refresh interval for the page. This refreshes the data on the page at the selected interval.
