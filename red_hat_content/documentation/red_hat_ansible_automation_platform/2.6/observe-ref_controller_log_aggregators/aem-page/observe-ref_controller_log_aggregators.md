...
title = "Configure third-party services - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/observe-ref_controller_log_aggregators"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/observe-ref_controller_log_aggregators/aem-page/observe-ref_controller_log_aggregators.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/observe-ref_controller_log_aggregators"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/observe-ref_controller_log_aggregators/toc/toc.json"
type = "aem-page"
+++
...
You can include the API error message for 4XX errors by modifying the log format for those messages. Refer to the [Set up logging](/documentation/en-us/red_hat_ansible_automation_platform/2.6/observe-ref_controller_log_aggregators#proc-controller-set-up-logging "To set up logging to any of the aggregator types for centralized logging follow these steps:").

 **LDAP**

You can enable logging messages for the LDAP adapter. For more information, see [Set up logging](/documentation/en-us/red_hat_ansible_automation_platform/2.6/observe-ref_controller_log_aggregators#proc-controller-set-up-logging "To set up logging to any of the aggregator types for centralized logging follow these steps:").
