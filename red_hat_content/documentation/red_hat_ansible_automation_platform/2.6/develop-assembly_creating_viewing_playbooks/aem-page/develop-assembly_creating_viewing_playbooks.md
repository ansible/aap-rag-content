+++
title = "Create playbooks and view playbook explanations - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-assembly_creating_viewing_playbooks"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-assembly_creating_viewing_playbooks/aem-page/develop-assembly_creating_viewing_playbooks.html"
last_crumb = "Create playbooks and view playbook explanations"
modified = "2026-05-21T14:12:12.122Z"
multi_page_path = ""
name = "Create playbooks and view playbook explanations"
oversized = "false"
page_slug = "develop-assembly_creating_viewing_playbooks"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/develop-assembly_creating_viewing_playbooks"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-assembly_creating_viewing_playbooks/toc/toc.json"
type = "aem-page"
+++
...
*Figure 1. Settings to create Ansible playbooks*

![Settings to create Ansible playbooks](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/lightspeed-create-ansible-content.png)

4.  Select the **Playbook with Ansible Lightspeed** tile. The **Create a playbook** page is displayed.
5.  In the **What do you want the playbook to accomplish?** field, enter the prompts to create a playbook and click **Analyze**. After a few seconds, the recommended steps for your playbook intent are displayed in the **Review the suggested steps for your playbook and modify as needed** field.
...
7.  After you verify the steps, click **Generate playbook**. It takes a few seconds for the playbook to generate, and **The following playbook was generated for you** field displays the newly generated playbook.
...
![Example of a playbook explanation](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/lightspeed-playbook-explanation.png)
