+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/configure-planning_your_cluster"
template = "docs/aem-title.html"
title = "Planning your cluster environment - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/configure-planning_your_cluster/aem-page/configure-planning_your_cluster.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/configure-planning_your_cluster"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/configure-planning_your_cluster/toc/toc.json"
type = "aem-page"
+++
...
![The job runtime workflow for clusters graphic shows how jobs submitted to a single API interface are distributed across hosts in a cluster.](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ug-clustering-visual.png)
