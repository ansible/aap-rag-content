...
html = "data/docs_assets_pv1/red_hat_ansible_automation_platform/2.6/using_automation_execution/single-page/5f1e02dd1896b517096f26e1513d9b93.html"
last_crumb = "Using automation execution"
modified = "2026-04-23T11:42:01.000Z"
...
solr_index = "true"
toc = "data/docs_assets_pv1/red_hat_ansible_automation_platform/2.6/using_automation_execution/toc/ea454b9cf0b42659fd686c1c07eeae10.json"
type = "single-page"
+++
...
[Legal Notice](#idm139632042487024)
...
For more information, see [OpenStack credential type](#ref-controller-credential-openstack "22.4.21.&nbsp;OpenStack credential type").
...
You can collect facts by using the fact caching feature. For more information, see [Fact Caching](#controller-fact-caching "6.13.&nbsp;Fact caching").
...
For more information, see [Red Hat Satellite 6](#proc-controller-inv-source-satellite "14.4.7.7.&nbsp;Red Hat Satellite 6").
...
For more information, see [Setting up Red Hat Lightspeed for Red Hat Ansible Automation Platform Remediations](#controller-setting-up-insights "Chapter&nbsp;28.&nbsp;Setting up Red Hat Lightspeed Remediations").
...
3. Click the More Actions icon **⋮** next to the required user.
...
1. To remove roles for a particular user, click the ![Disassociate](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_automation_execution-en-US/images/48c2fa70cf2a09ae0fafa81899b143fc/disassociate.png) icon next to its resource.
...
Use the toggles to enable or disable the notifications to use with your particular template. For more information, see [Enable and disable notifications](#controller-enable-disable-notifications "25.6.&nbsp;Enable and disable notifications").

If no notifications have been set up, click Add notifier to create a new notification. For more information about configuring various notification types and extended messaging, see [Notification types](#controller-notification-types "25.4.&nbsp;Notification types").
...
- [Openstack](#controller-openstack-cloud "6.16.&nbsp;OpenStack")
- [Amazon Web Services](#controller-aws-cloud "6.16.1.&nbsp;Amazon Web Services")
- [Google](#controller-google-cloud "6.16.2.&nbsp;Google")
- [Azure](#controller-azure-cloud "6.16.3.&nbsp;Azure")
- [VMware](#controller-vmware-cloud "6.16.4.&nbsp;VMware")
...
For information about working with notifications in workflow job templates, see [Work with notifications](#controller-work-with-notifications "6.6.&nbsp;Work with notifications").
...
For more information about scheduling a workflow job template run, see the [Scheduling job templates](#controller-scheduling-job-templates "6.8.&nbsp;Scheduling job templates") section.
...
For more information on job surveys, including how to create a survey and optional survey questions in workflow job templates, see the [Surveys in job templates](#controller-surveys-in-job-templates "6.9.&nbsp;Surveys in job templates") section.
...
Click the Edit ![Edit](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.6-Using_automation_execution-en-US/images/e5cb7f9b0cfe60ab5ba421bd17ecbb6a/leftpencil.png) icon to edit a schedule.
...
4. If notifications are already set up, use the toggles to enable or disable the notifications to use with your particular source. For more information, see [Enable and Disable Notifications](#controller-enable-disable-notifications "25.6.&nbsp;Enable and disable notifications").

5. If you have not set up notifications, see [Notifiers](#controller-notifications "Chapter&nbsp;25.&nbsp;Notifiers") for more information.
...
- [Instance groups](#con-controller-instance-groups "18.1.&nbsp;Instance groups")
- [Container groups](#controller-container-groups "18.2.&nbsp;Container groups")
