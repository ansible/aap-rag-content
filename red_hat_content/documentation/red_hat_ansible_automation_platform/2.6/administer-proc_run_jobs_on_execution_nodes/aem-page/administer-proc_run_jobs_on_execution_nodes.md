+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/administer-proc_run_jobs_on_execution_nodes"
template = "docs/aem-title.html"
title = "Run jobs on execution nodes - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/administer-proc_run_jobs_on_execution_nodes/aem-page/administer-proc_run_jobs_on_execution_nodes.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/administer-proc_run_jobs_on_execution_nodes"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/administer-proc_run_jobs_on_execution_nodes/toc/toc.json"
type = "aem-page"
+++
...
1.  The **Templates** list view shows job templates that are currently available. From this screen you can launch ![Launch](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/rightrocket.png), edit ![Edoit](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/leftpencil.png), and duplicate ![Duplicate](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/copy.png) a workflow job template.
2.  Select the job you want and click the ![Launch](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/rightrocket.png) icon.
...
![mesh ingress architecture](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/meshIngress.png)  
