+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_managing_authentication"
template = "docs/aem-title.html"
title = "Locate and manage authentication configurations - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_managing_authentication/aem-page/secure-assembly_gw_managing_authentication.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_managing_authentication"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-assembly_gw_managing_authentication/toc/toc.json"
type = "aem-page"
+++
...
2.  In the list view, you can either:
  1.  Select the Edit![Edit](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/leftpencil.png) icon next to authenticator you want to modify, or
