...
[extra]
modified = "2025-10-03T19:32:39.000Z"
...
<span id="idm139729048127888"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm139729052287280) 
 **Abstract** 
...
- Deployment of an LLM service that is hosted on either Red Hat Enterprise Linux AI, Red Hat OpenShift AI, or Red Hat AI Inference Server. To know the LLM providers that you can use, [LLM providers](#LLMproviders) .
...
MCP is an open protocol that standardizes how applications provide context to LLMs. Using the protocol, an MCP server provides a standardized way for an LLM to increase context by requesting and receiving real-time information from external resources. The integration with an MCP server enables the Ansible Lightspeed intelligent assistant to offer an enhanced user experience by delivering relevant, dynamically sourced data results to your queries. You can configure a MCP server in the chatbot configuration secret. For more information, see [Creating a chatbot configuration secret](#proc-create-chatbot-config-secret_deploying-chatbot-operator) .
...
### 5.1.4. Process for configuring and using the Ansible Lightspeed intelligent assistant
...
1.  [Create a chatbot configuration secret](#proc-create-chatbot-config-secret_deploying-chatbot-operator) .
1.  [Update the YAML file of the Ansible Automation Platform to use the chatbot connection secret](#proc-update-aap-operator-chatbot_deploying-chatbot-operator) . |
| Access and use the Ansible Lightspeed intelligent assistant | All Ansible users who want to use the intelligent assistant to get answers to their questions about the Ansible Automation Platform. For more details, see [Using the Ansible Lightspeed intelligent assistant](#con-using-chatbot_deploying-chatbot-operator) . |
...
### 5.2.2. Updating the YAML file of the Ansible Automation Platform operator
...
## 5.3. Using the Ansible Lightspeed intelligent assistant
