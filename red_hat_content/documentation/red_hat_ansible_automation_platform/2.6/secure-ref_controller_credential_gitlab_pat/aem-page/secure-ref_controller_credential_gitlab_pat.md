...
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/secure-ref_controller_credential_gitlab_pat"
title = "GitLab Personal Access Token credential type - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-ref_controller_credential_gitlab_pat/aem-page/secure-ref_controller_credential_gitlab_pat.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/secure-ref_controller_credential_gitlab_pat"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/secure-ref_controller_credential_gitlab_pat/toc/toc.json"
type = "aem-page"
+++
...
For more information, see [Setting up a GitLab webhook](/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-assembly_ug_controller_work_with_webhooks#controller-set-up-gitlab-webhook "Automation controller has the ability to run jobs based on a triggered webhook event coming in. Job status information (pending, error, success) can be sent back only for pull request events.").
