+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/proc_change_llm_model_chatbot_containerized_install"
title = "Change your LLM model - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/proc_change_llm_model_chatbot_containerized_install/aem-page/proc_change_llm_model_chatbot_containerized_install.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/proc_change_llm_model_chatbot_containerized_install"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/proc_change_llm_model_chatbot_containerized_install/toc/toc.json"
type = "aem-page"
+++
...
2.  Rerun the `install` playbook to [install the containerized Ansible Automation Platform](/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_installing_containerized_aap#installing-containerized-aap "Run the install playbook to install containerized Ansible Automation Platform after preparing the Red Hat Enterprise Linux host, downloading the installation program, and configuring the inventory file.").
