+++
title = "Control where automation runs with container groups - Red Hat Ansible Automation Platform 2.6"
template = "docs/aem-title.html"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/administer-con_controller_container_groups"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/administer-con_controller_container_groups/aem-page/administer-con_controller_container_groups.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/administer-con_controller_container_groups"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/administer-con_controller_container_groups/toc/toc.json"
type = "aem-page"
+++
...
![Customize pod specification](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ag-instance-group-customize-cg-pod.png)  
...
6.  When you have created the container group successfully, the **Details** tab of the newly created container group remains, which enables you to review and edit your container group information. This is the same menu that is opened if you click the ![Edit](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/leftpencil.png) icon from the **Instance Groups** list view. You can also edit **Instances** and review **Jobs** associated with this instance group.


![Instance group successfully created](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ag-instance-group-successfully-created.png)  
...
1.  Create a mock inventory and associate the container group to it by populating the name of the container group in the **Instance groups** field. For more information, see [Add a new inventory](/documentation/en-us/red_hat_ansible_automation_platform/2.6/proc_controller_adding_new_inventory "To add a new inventory, you must configure permissions, groups, hosts, and sources, then view the completed jobs.").  
![Create test inventory](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ag-inventories-create-new-test-inventory.png)  
...
![Launch ad hoc localhost](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ag-inventories-launch-adhoc-localhost.png)  

![Launch ad hoc localhost 2](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ag-inventories-launch-adhoc-localhost2.png)  
