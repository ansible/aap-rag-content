...
modified = "2026-02-11T12:00:02.000Z"
...
<span id="idm139625901500160"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm139625898629472) 
 **Abstract** 
...
1. If you do not find what you are looking for, you can narrow your search. From the filter list, select **Name** or **Authentication type** depending on the search term you want to use.
...
You can also revoke OAuth2 tokens by using the `manage` utility, see [Revoke oauth2 tokens](#ref-controller-revoke-oauth2-token) .
...
For more information about OAuth2 token management in the UI, see the [Applications](#assembly-controller-applications) .
...
1. To remove a single role, click the minus icon next to the resource and confirm removal on the dialog that is displayed.
...
1. Explore the available API endpoints, view required parameters, and test interactions with the resources exposed by platform gateway.
