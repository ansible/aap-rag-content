+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/install-proc_provision_ocp_storage_with_readwritemany"
template = "docs/aem-title.html"
title = "Provision OpenShift Container Platform storage with ReadWriteMany access mode - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_provision_ocp_storage_with_readwritemany/aem-page/install-proc_provision_ocp_storage_with_readwritemany.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/install-proc_provision_ocp_storage_with_readwritemany"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/install-proc_provision_ocp_storage_with_readwritemany/toc/toc.json"
type = "aem-page"
+++
