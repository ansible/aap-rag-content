...
title = "Add a new inventory - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/proc_controller_adding_new_inventory"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/proc_controller_adding_new_inventory/aem-page/proc_controller_adding_new_inventory.html"
last_crumb = "Add a new inventory"
modified = "2026-05-21T14:12:12.122Z"
multi_page_path = ""
name = "Add a new inventory"
oversized = "false"
page_slug = "proc_controller_adding_new_inventory"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/proc_controller_adding_new_inventory"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/proc_controller_adding_new_inventory/toc/toc.json"
type = "aem-page"
+++

# Add a new inventory

To add a new inventory, you must configure permissions, groups, hosts, and sources, then view the completed jobs.
...
1.  From the navigation panel, select Automation Execution> (and then)Infrastructure> (and then)Inventories. The **Inventories** window displays a list of the inventories that are currently available.
...
3.  Enter the appropriate details into the following fields:
  ...
  - Only applicable to Smart Inventories: **Smart host filter**: Populate the hosts for this inventory by using a search filter. For example "name__icontains=RedHat".
  ...
  - Only applicable to constructed inventories: **Verbosity**: Control the level of output that Ansible produces as the playbook executes related to inventory sources associated with constructed inventories. Select the verbosity from:
    ...
    * **WinRM Debug**
      ...
      + **WinRM Debug** used for verbosity specific to windows remote management                 Click the ![Expand](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/arrow.png) icon for information on **How to use the constructed inventory plugin**.
