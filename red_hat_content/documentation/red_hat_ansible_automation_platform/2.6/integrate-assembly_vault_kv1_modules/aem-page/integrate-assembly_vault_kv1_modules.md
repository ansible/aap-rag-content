...
title = "Configure KV1 modules - Red Hat Ansible Automation Platform 2.6"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/integrate-assembly_vault_kv1_modules"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/integrate-assembly_vault_kv1_modules/aem-page/integrate-assembly_vault_kv1_modules.html"
...
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/integrate-assembly_vault_kv1_modules"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/integrate-assembly_vault_kv1_modules/toc/toc.json"
type = "aem-page"
+++
...
- [Configure the `hashicorp.vault.kv1_secret_get` lookup plugin](/documentation/en-us/red_hat_ansible_automation_platform/2.6/integrate-assembly_vault_kv1_modules#vault-configuring-kv1-secret-get-lookup "The hashicorp.vault.kv1_secret_get lookup plugin module reads KV1 secrets.").
...
-  [Create a credential type](/documentation/en-us/red_hat_ansible_automation_platform/2.6/integrate-assembly_vault_authenticating#vault-creating-custom-credential "Vault users must create a custom credential to use with job templates in Ansible Automation Platform.")
