+++
title = "Build a graphical workflow representation with workflow visualizer - Red Hat Ansible Automation Platform 2.6"
template = "docs/aem-title.html"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-con_controller_workflow_visualizer"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-con_controller_workflow_visualizer/aem-page/develop-con_controller_workflow_visualizer.html"
...
oversized = "false"
page_slug = "develop-con_controller_workflow_visualizer"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/develop-con_controller_workflow_visualizer"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-con_controller_workflow_visualizer/toc/toc.json"
type = "aem-page"
+++
...
1.  To launch the workflow visualizer, use one of these methods:
  ...
  - From the **Automation Templates** list view, click the ![Visualizer](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/visualizer.png) icon next to a workflow job template.

2.  Click Add step to display a list of nodes to add to your workflow.
3.  From the **Node type** list, select the type of node that you want to add.   - If you select an **Approval** node, see [Approval nodes](/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-ref_controller_approval_nodes#controller-approval-nodes "Use an Approval node to manually pause a workflow between playbooks. This allows you to review and approve the next step within a set timeframe or advance the process immediately.") for more information. Selecting a node provides the available valid options associated with it.
...
6.  Select the behavior of the node if it is a convergent node from the **Convergence** field:
  ...
  - Choose **All** to ensure that all nodes complete as specified, before converging and triggering the next node. The purpose of **all*** nodes is to make sure that every parent meets its expected outcome to run the child node. The workflow checks to make sure every parent behaves as expected to run the child node. Otherwise, it will not run the child node. If selected, the node is labeled as **ALL** in the graphical view:
        ...
        ![Convergent node all](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ug-wf-editor-convergent-node-all.png)
...
![Workflow dropdown list](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ug-wf-dropdown-list.png)  
...
![Node options](/webassets/aem/red_hat_ansible_automation_platform/2.6/images/ug-wf-add-template.png)  

9.  When you have added or edited a node, click Finish to save any modifications and render it on the graphical view. For possible ways to build your workflow, see [Building nodes scenarios](/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-ref_controller_approval_nodes#controller-building-nodes-scenarios "Learn how to manage nodes in the following scenarios.").
