...
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-assembly_getting_started_lightspeed"
title = "Quick start for administrators - Red Hat Ansible Automation Platform 2.6"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-assembly_getting_started_lightspeed/aem-page/develop-assembly_getting_started_lightspeed.html"
last_crumb = "Quick start for administrators"
modified = "2026-05-21T14:12:12.122Z"
multi_page_path = ""
name = "Quick start for administrators"
oversized = "false"
page_slug = "develop-assembly_getting_started_lightspeed"
portal_content_subtype = "title"
product = "Red Hat Ansible Automation Platform"
product_slug = "red_hat_ansible_automation_platform"
product_version = "2.6"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/develop-assembly_getting_started_lightspeed"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.6/develop-assembly_getting_started_lightspeed/toc/toc.json"
type = "aem-page"
+++
...
- Log in to the Ansible Lightspeed admin portal     Use the Ansible Lightspeed admin portal to access and manage the Ansible Lightspeed service.

- View and manage the Admin dashboard telemetry data     View the operational telemetry and Admin dashboard telemetry data from the Ansible Lightspeed Admin dashboard. If you no longer want to collect the telemetry data for your organization, you can disable the Admin dashboard telemetry.
...
-  [Log in to the Ansible Lightspeed admin portal](/documentation/en-us/red_hat_ansible_automation_platform/2.6/develop-assembly_administering_ansible_lightspeed#log-in-administrator-portal "Use the Ansible Lightspeed administrator portal to connect Red Hat Ansible Lightspeed to IBM watsonx Code Assistant.")     Use the Ansible Lightspeed admin portal to access and manage the Ansible Lightspeed service.
