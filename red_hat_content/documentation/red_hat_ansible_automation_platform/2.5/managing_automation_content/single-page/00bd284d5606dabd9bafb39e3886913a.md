+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html-single/managing_automation_content/index"
title = "Managing automation content - Red Hat Ansible Automation Platform 2.5"

[extra]
modified = "2025-06-12T17:32:14.000Z"
multi_page_path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html/managing_automation_content/index/"
name = "Managing automation content"
page_slug = "managing_automation_content"
product = "Red Hat Ansible Automation Platform"
product_version = "2.5"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/managing_automation_content/index"
type = "single-page"
+++


<span id="idm140426121601184"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140426123339280) 
 **Abstract** 
...
1.  [Obtain an automation hub API token](#token-management-hub_cloud-sync) 
1.  [Use the API token to configure a remote repository in your local hub](#proc-set-rhcertified-remote_cloud-sync) 
1. Then, [Create a requirements file](#create-requirements-file_cloud-sync) .
...
Note
Your offline token expires after 30 days of inactivity. For more on obtaining a new offline token, see [Keeping your offline token active](#con-offline-token-active_cloud-sync) .
...
By default, automation hub includes one staging repository that is automatically used when a repository is not specified for uploading collections. Users can create new staging repositories during [repository creation](#proc-create-repository) .
...
<span id="idm140426123339280"></span>
# Legal Notice
