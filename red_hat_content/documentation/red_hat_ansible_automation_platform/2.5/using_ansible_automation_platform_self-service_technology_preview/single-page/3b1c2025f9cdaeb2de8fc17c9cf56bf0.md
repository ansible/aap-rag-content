+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html-single/using_ansible_automation_platform_self-service_technology_preview/index"
title = "Using Ansible Automation Platform self-service technology preview - Red Hat Ansible Automation Platform 2.5"

[extra]
modified = "2025-07-21T18:31:05.000Z"
multi_page_path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html/using_ansible_automation_platform_self-service_technology_preview/index/"
name = "Using Ansible Automation Platform self-service technology preview"
page_slug = "using_ansible_automation_platform_self-service_technology_preview"
product = "Red Hat Ansible Automation Platform"
product_version = "2.5"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/using_ansible_automation_platform_self-service_technology_preview/index"
type = "single-page"
+++


<span id="idm140460204702288"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140460209550192) 
 **Abstract** 
...
This guide describes how to add templates to your Ansible Automation Platform self-service technology preview instance, and how to launch them to run automation jobs. It also describes how to configure role-based access control (RBAC) so that you can restrict the teams and users who can run the jobs.
...
Important
Ansible Automation Platform self-service technology preview is a Technology Preview feature only.
...
To populate self-service technology preview with templates, you must create repositories in GitHub or Gitlab for collections that define the templates.

Currently, Red Hat provides validated content with examples to automate jobs for RHEL, Network, Windows, and Cloud using self-service technology preview.

Note
The validated content examples provided have their own support statement and lifecycle definitions. Refer to the [Red Hat Ansible Automation Platform Life Cycle](https://access.redhat.com/support/policy/updates/ansible-automation-platform#validated) .



These collections are hosted in automation hub. Your administrator must add the collections to private automation hub so that you can download them and create the repositories.

You can then import templates into your self-service technology preview, and launch them to run automation jobs.
...
- Your Ansible Automation Platform administrator has populated private automation hub with collections.
- You have permissions to access collections in private automation hub.
- You have installed and configured self-service technology preview.
...
## 3.1. Exporting a collection from private automation hub
...
1. From the navigation panel, selectAutomation Content→Collections.
    ...
    The **Collections** page displays all collections across all repositories. You can search for a specific collection.
    
    
1. Click into the collection that you want to export.
    
    The **Collection details** page opens.
    
    
1. From the **Install** tab, select **Download tarball** .
