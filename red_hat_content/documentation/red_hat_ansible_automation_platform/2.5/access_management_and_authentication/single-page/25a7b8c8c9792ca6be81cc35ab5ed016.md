...
[extra]
modified = "2025-06-20T18:10:12.000Z"
...
<span id="idm140322446355424"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140322435663072) 
 **Abstract** 
...
For more information, see [Attaching Subscriptions](#proc-attaching-subscriptions) .
...
-  [Add the subscriptions](#proc-add-merge-subscriptions) needed for Ansible Automation Platform to run properly.
...
-  [Download the manifest file](#proc-aap-generate-manifest-file) from Red Hat Subscription Management.
...
For more information on using the `manage` utility to create tokens, see [Token and session management](#ref-controller-token-session-management) .
