...
[extra]
modified = "2025-10-01T20:26:48.000Z"
...
<span id="idm140397712339360"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140397700286224) 
 **Abstract** 
...
-  [Notification types](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/using_automation_execution/controller-notifications#controller-notification-types) 
...
Note
Teams cannot be assigned to an organization by adding roles. Refer to the steps provided in [Adding a team to an organization](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/access_management_and_authentication/gw-managing-access#proc-gw-add-team-organization) for detailed instructions.
...
1. Select the **Organization** to be assigned for this user. For information about creating a new organization, see [Creating an organization](#proc-controller-create-organization) .
1. ClickCreate user.
