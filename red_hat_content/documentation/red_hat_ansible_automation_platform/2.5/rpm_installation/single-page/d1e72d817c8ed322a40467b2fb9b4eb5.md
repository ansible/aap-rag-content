+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html-single/rpm_installation/index"
title = "RPM installation - Red Hat Ansible Automation Platform 2.5"

[extra]
modified = "2025-06-23T13:58:51.000Z"
multi_page_path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html/rpm_installation/index/"
name = "RPM installation"
page_slug = "rpm_installation"
product = "Red Hat Ansible Automation Platform"
product_version = "2.5"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/rpm_installation/index"
type = "single-page"
+++


<span id="idm140675902722528"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140675902584672) 
 **Abstract** 
...
1. For more information about the supported installation scenarios, see the [Planning your installation](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/planning_your_installation) .
1. For more information on available topologies, see [Tested deployment models](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/tested_deployment_models) .
...
For an example of setting Event-Driven Ansible controller maximumrunning activations, see [Single automation controller, single automation hub, and single Event-Driven Ansible controller node with external (installer managed) database](#ref-gateway-controller-hub-eda-ext-db) .
...
To set up a multi-node deployment, follow the procedure in [Setting up horizontal scaling for Event-Driven Ansible controller](#proc-hs-eda-setup) .
...
Note
See section [3.2 Inventory file examples base on installation scenarios](#con-install-scenario-examples) for a list of examples that best fits your scenario.
