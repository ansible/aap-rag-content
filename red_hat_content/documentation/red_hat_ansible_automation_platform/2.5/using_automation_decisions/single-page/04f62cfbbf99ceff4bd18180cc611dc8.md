...
[extra]
modified = "2025-06-19T15:38:46.000Z"
...
<span id="idm140185586140880"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140185580474400) 
 **Abstract** 
...
-  [Credential types](#eda-credential-types) 
-  [Projects](#eda-projects) 
-  [Decision environments](#eda-decision-environments) 
-  [Red Hat Ansible Automation Platform credential](#eda-set-up-rhaap-credential-type) 
-  [Rulebook activations](#eda-rulebook-activations) 
-  [Rulebook activations troubleshooting](#eda-rulebook-troubleshooting) 
-  [Rule audit](#eda-rule-audit) 
-  [Simplified event routing](#simplified-event-routing) 
-  [Performance tuning for Event-Driven Ansible controller](#eda-performance-tuning) 
-  [Event filter plugins](#eda-event-filter-plugins) 
-  [Event-Driven Ansible logging strategy](#eda-logging-strategy) 
...
For more information, see [Custom credential types](#eda-custom-credential-types) .
...
For information about how to create a new credential, see [Setting up credentials](#eda-set-up-credential) .
...
- You have set up a credential, if necessary. For more information, see the [Setting up credentials](#eda-set-up-credential) section.
...
To create your own decision environment, see [Installing ansible-builder](#eda-controller-install-builder) and [Building a custom decision environment for Event-Driven Ansible within Ansible Automation Platform](#eda-build-a-custom-decision-environment) .
...
After deleting the controller tokens and rulebook activations, proceed with [Setting up a Red Hat Ansible Automation Platform credential](#eda-set-up-rhaap-credential) .
...
A rulebook activation is a process running in the background defined by a decision environment executing a specific rulebook. You can set up your rulebook activation by following [Setting up a rulebook activation](#eda-set-up-rulebook-activation) .
...
To view events that came in and triggered an action, you can use the [Rule Audit](#eda-rule-audit) section in the Event-Driven Ansible controller Dashboard.
...
- If you plan to connect to automation controller to run your rulebook activation, ensure that you have created a Red Hat Ansible Automation Platform credential type in addition to the decision environment and project. For more information, see [Setting up a Red Hat Ansible Automation Platform credential](#eda-set-up-rhaap-credential) .
