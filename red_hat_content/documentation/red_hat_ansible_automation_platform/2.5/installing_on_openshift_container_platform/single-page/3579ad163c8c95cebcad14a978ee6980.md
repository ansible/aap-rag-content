...
<span id="idm140032595995472"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140032594880912) 
 **Abstract** 
...
- See [Understanding OperatorHub](https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/operators/understanding-operators#olm-understanding-operatorhub) to learn more about OpenShift Container Platform OperatorHub.
...
1. Update the YAML file of the Ansible Automation Platform to use the chatbot connection secret |
