...
[extra]
modified = "2025-08-07T18:56:11.000Z"
...
<span id="idm139640182166240"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm139640182172048) 
 **Abstract** 
...
| Ansible Automation Platform 2.5 to 2.5.x |  [Download the installation package](#proc-choosing-obtaining-installer_aap-upgrading-platform) .
 ...
 [Back up your Ansible Automation Platform instance](#con-backup-aap_aap-upgrading-platform) .
...
- Upgrades of Event-Driven Ansible version 2.4 to 2.5 are not supported. Database migrations between Event-Driven Ansible 2.4 and Event-Driven Ansible 2.5 are not compatible. For more information, see [automation controller and automation hub 2.4 and Event-Driven Ansible 2.5 with unified UI upgrades](#upgrade-controller-hub-eda-unified-ui_aap-upgrading-platform) .
...
-  [Backup and restore](#con-backup-aap_aap-upgrading-platform) 
