...
[extra]
modified = "2025-06-20T18:10:13.000Z"
...
<span id="idm140477683114928"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140477686559312) 
 **Abstract** 
...
- For more information about configuring monitoring, see [Metrics](#assembly-controller-metrics) .
...
To remove expired OAuth2 tokens, click the launch![Launch](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Configuring_automation_execution-en-US/images/15376a8ac10d1efa9ec8cb3d4c707dfd/rightrocket.png)
icon next to **Cleanup Expired OAuth2 Tokens** .
...
For more information, see [Scheduling deletion](#proc-controller-scheduling-deletion) .

You can also set or review notifications associated with this management job the same way as described in [Setting notifications](#proc-controller-management-notifications) for activity stream management jobs.

For more information, see [Notifications](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/using_automation_execution/controller-notifications) in _Using automation execution_ .
...
This uses the fields common to all loggers listed in [Log message schema](#ref-controller-log-message-schema) .
...
This logger also includes the common fields in [Log message schema](#ref-controller-log-message-schema) .
...
This logger also includes the common fields in [Log message schema](#ref-controller-log-message-schema) and fields present on the job model.
...
-  [Splunk](#ref-controller-logging-splunk) 
-  [Loggly](#ref-controller-logging-loggly) 
-  [Sumologic](#ref-controller-logging-sumologic) 
-  [Elastic Stack (formerly ELK stack)](#ref-controller-logging-elastic-stack) 
...
1. You can configure the following options:
    ...
    -  **Log Format For API 4XX Errors** : Configure a specific error message. For more information, see [API 4XX Error Configuration](#proc-controller-api-4xx-error-config) . Set the following options:
...
You can include the API error message for 4XX errors by modifying the log format for those messages. Refer to the [API 4XX Error Configuration](#proc-controller-api-4xx-error-config) .
...
You can enable logging messages for the LDAP adapter. For more information, see [API 4XX Error Configuration](#proc-controller-api-4xx-error-config) .
...
1. Create an external credential for authenticating with the secret management system. At minimum, give a name for the external credential and select one of the following for the **Credential type** field:
    ...
    -  [AWS Secrets Manager Lookup](#ref-aws-secrets-manager-lookup) 
    -  [Centrify Vault Credential Provider Lookup](#ref-centrify-vault-lookup) 
    -  [CyberArk Central Credential Provider (CCP) Lookup](#ref-cyberark-ccp-lookup) 
    -  [CyberArk Conjur Secrets Manager Lookup](#ref-cyberark-conjur-lookup) 
    -  [HashiCorp Vault Secret Lookup](#ref-hashicorp-vault-lookup) 
    -  [HashiCorp Vault Signed SSH](#ref-hashicorp-signed-ssh) 
    -  [Microsoft Azure Key Vault](#ref-azure-key-vault-lookup) 
    -  [Thycotic DevOps Secrets Vault](#ref-thycotic-devops-vault) 
    -  [Thycotic Secret Server](#ref-thycotic-secret-server) 
    -  [GitHub app token lookup](#controller-github-app-token) 
