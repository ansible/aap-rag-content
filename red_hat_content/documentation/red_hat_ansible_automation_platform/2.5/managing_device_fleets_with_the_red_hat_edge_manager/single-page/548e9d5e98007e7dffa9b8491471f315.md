+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html-single/managing_device_fleets_with_the_red_hat_edge_manager/index"
title = "Managing device fleets with the Red Hat Edge Manager - Red Hat Ansible Automation Platform 2.5"

[extra]
modified = "2025-06-12T17:32:14.000Z"
multi_page_path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html/managing_device_fleets_with_the_red_hat_edge_manager/index/"
...
product_version = "2.5"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/managing_device_fleets_with_the_red_hat_edge_manager/index"
type = "single-page"
+++


<span id="idm140467236211216"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140467246368928) 
 **Abstract** 
...
- See [Building a bootc operating system image for the Red Hat Edge Manager](#edge-manager-build-bootc) 
- See [Special considerations for building images](#edge-manager-images-special-considerations) .
...
-  [Installing the Red Hat Edge Manager CLI](#edge-manager-install-CLI) 
-  [Optional: Requesting an enrollment certificate for early binding](#edge-manager-request-cert) 
-  [Optional: Using image pull secrets](#edge-manager-image-pullsecrets) 
-  [Building the operating system image with bootc](#edge-manager-build-bootc-image) 
-  [Signing and publishing the bootc operating system image by using Sigstore](#edge-manager-build-sign-image) 
-  [Building the operating system disk image](#edge-manager-build-disk-image) 
-  [Optional: Signing and publishing the operating system disk image to an Open Container Initiative registry](#edge-manager-sign-disk-image) 
...
- See [Building images for Red Hat OpenShift Virtualization](#edge-manager-virt) .
...
- For more information about device lifecycle hooks and the default rules used by the Red Hat Edge Manager agent, see [Use device lifecycle hooks](#edge-manager-device-lifecycle) .
