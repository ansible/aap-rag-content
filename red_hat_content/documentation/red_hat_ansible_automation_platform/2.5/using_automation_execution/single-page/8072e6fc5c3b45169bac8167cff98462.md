+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html-single/using_automation_execution/index"
title = "Using automation execution - Red Hat Ansible Automation Platform 2.5"

[extra]
modified = "2025-06-18T08:05:12.000Z"
multi_page_path = "/documentation/en-us/red_hat_ansible_automation_platform/2.5/html/using_automation_execution/index/"
name = "Using automation execution"
page_slug = "using_automation_execution"
product = "Red Hat Ansible Automation Platform"
product_version = "2.5"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html-single/using_automation_execution/index"
type = "single-page"
+++


<span id="idm140173725194128"></span>
...
Red Hat Customer Content Services
 ...
 [Legal Notice](#idm140173724681600) 
 **Abstract** 
...
![sort arrow](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/6f66263442890fd4e275490c7cc6d7bc/sort-order-example.png)
...
Use the navigation menu toRelaunch job,Cancel job, download![Download](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/8a61e20c21c53f44e207c84d454159ec/download.png)
the job output, or delete![Delete](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/6cfc80c0460fa4d4d18be2d2f5df16fa/delete-button.png)
the job.
...
For Workflow job templates, see [Workflow job templates](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/using_automation_execution/controller-workflow-job-templates) .
...
- A positive timeout sets the timeout for that job template. | Yes |
    ...
    |  **Instance groups** | Choose [Instance and Container Groups](#controller-instance-and-container-groups) to associate with this job template. If the list is extensive, use the![examine](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/4e440067d24ca0b7a2a91901d3b3778f/examine.png)
icon to narrow the options. Job template instance groups contribute to the job scheduling criteria, see [Job Runtime Behavior](https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.5/html/configuring_automation_execution/controller-clustering#controller-cluster-job-runtime) and [Control where a job runs](#controller-control-job-run) for rules. A System Administrator must grant you or your team permissions to be able to use an instance group in a job template. Use of a container group requires admin rights. | - Yes.
...
1. Delete a job template using the following method:
    ...
    - Click the ⋮ icon and select the Delete Template![Delete Template](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/6cfc80c0460fa4d4d18be2d2f5df16fa/delete-button.png)
        icon, or
    - Select the required job template, on the **Details** page click the ⋮ icon and select![Delete template](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/6cfc80c0460fa4d4d18be2d2f5df16fa/delete-button.png)
        Delete template.
...
Click the Edit![Edit](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/e5cb7f9b0cfe60ab5ba421bd17ecbb6a/leftpencil.png)
icon to edit a schedule.

![Schedules sample list](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/2c5cb207c50270f95d1a043508c80f0b/ug-schedules-sample-list.png)
...
1. From the navigation panel, selectAutomation Execution→Projects.
1. Select the project that you want to update and click the **User Access** or **Team Access** tab.
1. Click the![Disassociate](https://access.redhat.com/webassets/avalon/d/Red_Hat_Ansible_Automation_Platform-2.5-Using_automation_execution-en-US/images/48c2fa70cf2a09ae0fafa81899b143fc/disassociate.png)
...
1.  **Construct 2 groups, limit to intersection** :
    ...
    When a variable is or is not defined (depending on the host), you can give a default. For example, use `    | default("running")` if you know what value it should have when it is not defined. This helps with debugging, as described in [Debugging tips](#ref-controller-inv-debugging-tips) .
...
- For more information about the policy or rules associated with instance groups, see the [Instance groups](#con-controller-instance-groups) section of the _Configuring automation execution_ .
- For more information about connecting your instance group to a container, see [Container groups](#controller-container-groups) .
...
The instances are run in accordance with instance group policies. For more information, see [Instance group policies](#controller-instance-group-policies) .
...
To set the maximum values for the concurrent jobs and forks in an instance group, see [Creating an instance group](#controller-create-instance-group) .
...
Container groups are different from execution environments in that execution environments are container images and do not use a virtual environment. For more information, see [Execution environments](#assembly-controller-execution-environments) .
...
To create a container group, create an [OpenShift or Kubernetes API Bearer Token](#ref-controller-credential-openShift) credential to use with your container group. For more information, see [Creating new credentials](#controller-create-credential) .
...
1. Create a mock inventory and associate the container group to it by populating the name of the container group in the **Instance groups** field. For more information, see [Add a new inventory](#proc-controller-adding-new-inventory) .
...
For more information, see [Automation controller capacity determination and job impact](#controller-capacity-determination) .
...
-  [additional_build_files](#ref-controller-additional-build-files) 
-  [additional_build_steps](#ref-controller-additional-build-steps) 
-  [build_arg_defaults](#ref-controller-build-arg-defaults) 
-  [dependencies](#ref-controller-dependencies) 
-  [images](#ref-controller-images) 
    
    
    -  [image verification](#ref-controller-image-verification) 
    
-  [options](#ref-controller-config-options) 
-  [version](#ref-controller-config-version) 
...
1. Enter the appropriate details depending on the type of credential selected, as described in [Credential types](#ref-controller-credential-types) .
...
1. Chose a job template or select **Create job template** from the **Create template** list to assign the credential to additional job templates.
    ...
    For more information about creating new job templates, see the [Job templates](#controller-job-templates) section.
...
-  [Amazon Web Services](#ref-controller-credential-aws) 
-  [Ansible Galaxy/Automation Hub API Token](#ref-controller-credential-galaxy-hub) 
-  [AWS Secrets Manager Lookup](#ref-controller-aws-secrets-lookup) 
-  [Bitbucket Data Center HTTP Access Token](#ref-controller-credential-bitbucket) 
-  [Centrify Vault Credential Provider Lookup](#ref-controller-credential-centrify-vault) 
-  [Container Registry](#ref-controller-credential-container-registry) 
-  [CyberArk Central Credential Provider Lookup](#ref-controller-credential-cyberark-central) 
-  [CyberArk Conjur Secrets Manager Lookup](#ref-controller-credential-cyberark-conjur) 
-  [GitHub Personal Access Token](#ref-controller-credential-gitHub-pat) 
-  [GitLab Personal Access Token](#ref-controller-credential-gitLab-pat) 
-  [Google Compute Engine](#ref-controller-credential-GCE) 
-  [GPG Public Key](#ref-controller-credential-GPG-public-key) 
-  [HashiCorp Vault Secret Lookup](#ref-controller-credential-hasiCorp-secret) 
-  [HashiCorp Vault Signed SSH](#ref-controller-credential-hashiCorp-vault) 
-  [Insights](#ref-controller-credential-insights) 
-  [Machine](#ref-controller-credential-machine) 
-  [Microsoft Azure Key Vault](#ref-controller-credential-azure-key) 
-  [Microsoft Azure Resource Manager](#ref-controller-credential-azure-resource) 
-  [Network](#ref-controller-credential-network) 
-  [OpenShift or Kubernetes API Bearer Token](#ref-controller-credential-openShift) 
-  [OpenStack](#ref-controller-credential-openstack) 
-  [Red Hat Ansible Automation Platform](#ref-controller-credential-aap) 
-  [Red Hat Satellite 6](#ref-controller-credential-satellite) 
-  [Red Hat Virtualization](#ref-controller-credential-virtualization) 
-  [Source Control](#ref-controller-credential-source-control) 
-  [Terraform Backend Configuration](#ref-controller-credential-terraform) 
-  [Thycotic DevOps Secrets Vault](#ref-controller-credential-thycotic-vault) 
-  [Thycotic Secret Server](#ref-controller-credential-thycotic-server) 
-  [Vault](#ref-controller-credential-vault) 
-  [VMware vCenter](#ref-controller-credential-vmware-vcenter) 
...
For more information, see [Using Collections with automation hub](#proc-projects-using-collections-with-hub) .
...
For more information, see [Instance and container groups](#controller-instance-and-container-groups) .
...
If you are interested in using OpenStack Cloud Credentials, see [Use Cloud Credentials with a cloud inventory](#controller-cloud-credentials) , which includes a sample playbook.
...
For more information on configuring custom notifications, see [Create custom notifications](#controller-create-custom-notifications) . The following sections give further details on each type of notification.
...
For a list of supported attributes and the proper syntax construction, see the [Supported attributes for custom notifications](#controller-attributes-custom-notifications) section.
...
For more information on working with these types of nodes, see [Approval nodes](#controller-approval-nodes) .
...
To create a new inventory to use with Red Hat Insights, see [Creating Insights credentials](#proc-controller-inv-source-insights) .
...
The combination of an Ansible playbook and the set of parameters required to launch it. For more information, see [Job templates](#controller-job-templates) .
