...
product_version = "2.7"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/develop-assembly_controller_projects"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.7/develop-assembly_controller_projects/toc/toc.json"
type = "aem-page"
+++
...
For each project listed, you can get the latest SCM revision ![Refresh](/webassets/aem/red_hat_ansible_automation_platform/2.7/images/sync.png), edit ![Edit](/webassets/aem/red_hat_ansible_automation_platform/2.7/images/leftpencil.png) the project, or duplicate ![Copy](/webassets/aem/red_hat_ansible_automation_platform/2.7/images/copy.png) the project attributes, using the icons next to each project.
