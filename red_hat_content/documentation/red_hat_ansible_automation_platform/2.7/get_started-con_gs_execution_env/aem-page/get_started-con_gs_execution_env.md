+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.7/get_started-con_gs_execution_env"
title = "Create automation runtimes with execution and decision environments - Red Hat Ansible Automation Platform 2.7"
...
product_version = "2.7"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/get_started-con_gs_execution_env"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.7/get_started-con_gs_execution_env/toc/toc.json"
type = "aem-page"
+++
...
For more information, see [Populating your private automation hub container registry](/documentation/en-us/red_hat_ansible_automation_platform/2.7/administer-con_container_registry#populate-container-registry "The automation hub remote registry is used for storing and managing automation execution environments.").
