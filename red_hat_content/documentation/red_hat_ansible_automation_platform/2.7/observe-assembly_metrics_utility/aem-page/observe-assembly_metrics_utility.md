+++
title = "Generate consumption-based billing reports with the metrics-utility - Red Hat Ansible Automation Platform 2.7"
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.7/observe-assembly_metrics_utility"
...
product_version = "2.7"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/observe-assembly_metrics_utility"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.7/observe-assembly_metrics_utility/toc/toc.json"
type = "aem-page"
+++
