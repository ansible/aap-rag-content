+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.7/install-proc_hub_route_options"
template = "docs/aem-title.html"
title = "Configure automation hub route options - Red Hat Ansible Automation Platform 2.7"
...
html = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.7/install-proc_hub_route_options/aem-page/install-proc_hub_route_options.html"
...
product_version = "2.7"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/install-proc_hub_route_options"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.7/install-proc_hub_route_options/toc/toc.json"
type = "aem-page"
+++
