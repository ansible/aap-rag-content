+++
path = "/documentation/en-us/red_hat_ansible_automation_platform/2.7/install-assembly_setup_postgresql_ext_database"
template = "docs/aem-title.html"
title = "Configure an external (customer provided) PostgreSQL database - Red Hat Ansible Automation Platform 2.7"
...
product_version = "2.7"
reference_url = "https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/install-assembly_setup_postgresql_ext_database"
solr_index = "true"
toc = "data/docs_assets_aem/red_hat_ansible_automation_platform/2.7/install-assembly_setup_postgresql_ext_database/toc/toc.json"
type = "aem-page"
+++
